...
<form name="form1" method="post" action="#">
  <table width="344" height="200" border="8" align="center">
    ...
    <tr>
      ...
      <td width="54"><a href="artist_details_edit.php?aid=<?php echo $row['aid'];?>">edit</a></td>
      <td width="85"><a href="artist_details_delete.php?aid=<?php echo $row['aid'];?>">delete</a></td>
    </tr>
	<?php
	}
	?>
