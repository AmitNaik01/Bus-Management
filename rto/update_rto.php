...
$query = "SELECT * FROM rto_details where rid = '$id' ";
...
?>
    ...
    <div class="container">
    <div class="close"><a href="../rto/rto.php">+</a></div>
        <div class="title">
           Update Bus Details
        </div>
...
<?php
    ...
    if($_POST['update'])
    {
        ...
        <meta http-equiv = "refresh" content ="0; url = http://localhost/demo/bus/bus.php#"  />
