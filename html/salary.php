        ...
        <div class="sidebar">
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="salary.php" class="active"><img src="../img/salary.png" alt=""><span>Salary</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="../login/changepss.php" ><img src="../img/lock.png" alt=""><span>change Password</span></a>
                    </li>
                </ul>
            </div>
        </div>
